...
uv run ruff format . && uv run ruff check .`,
    ...
    },
    {
      ...
      blocks: [
        ...
        "You now have the backend skeleton for every GenAI project in this plan: DocChat (Day 6) adds document and chunk tables and a `rag` service; the agent project adds tools that call these services.",
      ],
    },
  ],
  revise: [
