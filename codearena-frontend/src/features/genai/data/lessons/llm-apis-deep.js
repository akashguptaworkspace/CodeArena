      ...
      blocks: [
        {
          table: {
            ...
            rows: [
              ...
              ["ReAct", "Interleave reasoning and tool actions (the basis of agents, Days 12–13)"],
              ["Retrieval-augmented", "Put relevant documents into the prompt (Days 7–11)"],
            ],
          },
        },
      ],
...
print(r.text)`,
    ...
    },
    {
      ...
      blocks: [
        ...
        "Tool calling in a loop is an **agent**. On Days 13–14 you'll build agents with LangChain and LangGraph, and on Day 15 you'll expose tools through MCP so any model or app can use them.",
      ],
    },
  ],
  revise: [
      ...
      blocks: [
        {
          table: {
            ...
            rows: [
              ...
              ["Prompt and model quality", "Evals on a test set with scores (Day 11), run on prompt/model changes"],
