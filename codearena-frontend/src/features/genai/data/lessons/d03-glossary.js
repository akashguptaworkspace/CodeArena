      ...
      blocks: [
        {
          table: {
            ...
            rows: [
              ...
              ["Vector database", "Stores embeddings and finds nearest neighbours fast (Day 8)"],
      ...
      blocks: [
        {
          table: {
            ...
            rows: [
              ...
              ["Fine-tuning", "Further training a pretrained model on your data (Day 17)"],
      ...
      blocks: [
        {
          table: {
            ...
            rows: [
              ...
              ["Structured output / JSON mode", "Output constrained to a JSON schema (Day 5)"],
              ["Tool / function calling", "The model requests a function call with JSON arguments (Days 12–13)"],
            ],
          },
        },
      ],
      ...
      blocks: [
        {
          table: {
            head: ["Term", "Meaning"],
            rows: [
              ["RAG", "Retrieve relevant documents and give them to the model as context (Days 7–11)"],
              ["Chunking", "Splitting documents into retrievable pieces (Day 7)"],
              ["Hybrid search / reranking", "Combining keyword and vector search / re-ordering results with a stronger model (Day 10)"],
              ["Agent", "An LLM calling tools in a loop to reach a goal (Day 13)"],
              ["MCP", "Model Context Protocol: an open standard for connecting models to tools and data (Day 15)"],
              ...
              ["Eval / golden dataset", "A test set with expected outputs for measuring quality (Day 11)"],
              ["LLM-as-judge", "Using a model to grade outputs (Day 11)"],
